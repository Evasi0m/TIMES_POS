    ...
    <div className={`rounded-xl border-2 p-3 ${meta.card} ${row.needsReview ? 'ring-2 ring-warning/40' : ''}`}>
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1 pt-0.5">
          <div className="text-base font-semibold text-ink truncate leading-tight flex items-center gap-1.5">
      ...
      <div className="grid grid-cols-2 gap-2 mt-3">
        ...
        <label className="block">
          <span className={'text-[11px] mb-1 block flex items-center justify-between gap-1 ' + (costIncomplete ? 'text-warning font-medium' : 'text-muted-soft')}>
...
export function ResolveBlock({ row, products, hasVat = false, onPick, onCreateNew }) {
