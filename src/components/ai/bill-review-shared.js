...
export const DISPLAY_STATE_META = {
  ...
  missing: {
    ...
    pillCls: 'air-status-chip--missing',
    label: 'ไม่พบในระบบ',
    icon: 'alert',
  ...
  incomplete: {
    ...
    pillCls: 'air-status-chip--incomplete',
    label: 'กรอกตัวเลข',
    icon: 'alert',
  ...
  tiktok: {
    ...
    pillCls: 'air-status-chip--tiktok',
    label: 'จับ TikTok',
    icon: 'store',
